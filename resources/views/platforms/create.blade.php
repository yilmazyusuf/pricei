...
@section('meta.title', 'Platformlar ›› Yeni Platform')
...
@section('content')
    <div class="breadcrumb align-items-center">
        <h1 class="mr-2">Platform Oluştur</h1>
        <ul>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-6 col-sm-6">
            <form class="ajax" action="{{route('platforms.store')}}" method="post">
                <div class="card mb-5">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <button class="btn btn-primary ajax_btn " type="submit">Kaydet</button>
                    </div>
                </div>
            </form>
