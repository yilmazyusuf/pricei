<div class="main-header">
    ...
    <div class="header-part-right">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right notification-dropdown rtl-ps-none ps" aria-labelledby="dropdownNotification" data-perfect-scrollbar="" data-suppress-scroll-x="true" x-placement="bottom-end" style="position: absolute; transform: translate3d(-253px, 36px, 0px); top: 0px; left: 0px; will-change: transform;">
